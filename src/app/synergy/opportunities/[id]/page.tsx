...
export default async function ListingDetailPage({
    ...
    const transformedListing = {
        ...
        suiteData: listing.suiteDataSnapshot
            ? JSON.parse(JSON.stringify(listing.suiteDataSnapshot))
            : null,
    };
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-amber-800">
                                This listing contains demonstration data for
                                preview purposes. The metrics, verification
                                status, and seller information shown here are
                                examples to illustrate the platform's
                                capabilities. Real listings will display actual
                                verified data from connected wallets and
                                on-chain sources.
                            </p>
                        </div>
                    </div>
                        ...
                        {transformedListing.suiteData && (
                            <SuiteRibbon
                                ...
                                data={{
                                    ...
                                    revenue_verified:
                                        transformedListing.revenue, // Pass actual revenue value
                                    fabrknt_score:
                                        transformedListing.suiteData
                                            .fabrknt_score,
                                }}
                    ...
                    <div className="space-y-6">
                                ...
                                <div className="rounded-lg bg-muted p-4 text-center">
                                    <p className="text-sm text-muted-foreground">
                                        ...
                                        <span className="font-semibold">
                                            {transformedListing.status.replace(
                                                "_",
                                                " "
                                            )}
                                        </span>
                        ...
                        <div className="rounded-lg border border-green-200 bg-green-50 p-6">
                            ...
                            <p className="text-xs text-green-700 mb-4">
                                Our M&A advisors are here to assist you through
                                the process.
                            </p>
