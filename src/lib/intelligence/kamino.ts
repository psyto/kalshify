/**
 * Kamino Finance Intelligence Data Fetcher
 */
...
export async function fetchKaminoData(): Promise<IntelligenceData> {
    try {
        console.log("Fetching Kamino Finance intelligence data...");
...
export async function calculateKaminoScore(
    ...
    const intelligenceData = data || (await fetchKaminoData());
...
export async function getKaminoCompanyData(
    ...
    const intelligenceScore =
        score || (await calculateKaminoScore(intelligenceData));
